...
@WebServlet(name = "fremtidigeBookinger", value = "/fremtidigeBookinger")
public class FutureBookingsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/bookingsFuture.jsp").forward(request, response);
    ...
    public LinkedHashMap<ToolModel, BookingModel> listBookings(int userID, String search) {
        ...
        return bDao.getFutureBookings(userID, search);
    }
